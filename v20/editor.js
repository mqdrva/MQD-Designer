...
function makeShirtPreviewArtwork(zone,maxSide,options={}){
 ...
 const settings={...options,flipX:longPoloCollar?true:options.flipX,
  textStyle:longPoloCollar?layer=>({...layer,scale:(layer.scale||1)*1.5,weight:layer.bold===false?400:900,
   ...(layer.bold!==false&&!Number(layer.strokeWidth)?{strokeWidth:.8,strokeColor:layer.color||'#111111'}:{})}):options.textStyle,
