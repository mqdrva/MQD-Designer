...
function rebuildHoodMaskPreview(){
 ...
 for(const [zone,mesh] of hoodMaskPanels){
  const artwork=makeCleanZoneArtworkCanvas(zone,1600),canvas=document.createElement('canvas');
