...
// Mask GLB is code-authoritative so an older locally saved catalog cannot keep the obsolete model URL.
...
function renderLayerPanel(){
  ...
  $('layerScale').max=product.id==='lightweight-jacket'?'260':'220';
...
function rebuildHoodMaskPreview(){
 ...
 for(const [zone,mesh] of hoodMaskPanels){
  const textMap={flipX:zone.includes('Sleeve'),offsetY:zone==='Front'||zone==='Back'?-.13:0};
