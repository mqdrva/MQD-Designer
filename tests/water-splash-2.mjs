...
import {WATER_SPLASH_2,isWaterSplash2,drawFittedSplash,splashFit} from '../v20/water-splash-fit.js';
...
for(const product of products){
 ...
 for(const zone of product.zones){
  ...
  ctx.layer={type:'image',libraryAssetId:WATER_SPLASH_2,libraryLocked:true,image};ctx.b=b;ctx.canvas=flat;
