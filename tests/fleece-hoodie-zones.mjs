...
assert.equal(zoneAt(.34,.50,.05),2,'inner upper left arm must belong to Left Sleeve');
assert.equal(zoneAt(-.34,.50,.05),3,'inner upper right arm must belong to Right Sleeve');
